...
$lang = array(
    ...
    'Assign task to device' => 'Assign task to device',
    ...
    'Auth sequence field represents the authentication sequence for the particular device. The following tags are available for usage in the sequence while being substituted by related values from credentials:' => 'Auth sequence field represents the authentication sequence for the particular device. The following tags are available for usage in the sequence while being substituted by related values from credentials:',
    ...
    'Device name should start with letter and contain only a-z, 0-9 or underscore' => 'Device name should start with letter and contain only a-z, 0-9 or underscore',
