...
$page_name   = ($action == 'add') ? Yii::t('network', 'Add scheduled task') : Yii::t('network', 'Edit scheduled task');
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-default">
            ...
            <?php $form = ActiveForm::begin(['id' => 'schedule_form', 'enableClientValidation' => false]); ?>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <?php
                    ...
                    <?php
                        if($action == 'edit') {
                            echo Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->id], [
                                ...
                                'data' => [
                                    'confirm' => Yii::t('app', 'Are you sure you want to delete record {0}?', $model->task_name),
                                    'method'  => 'post',
                                ],
                            ]);
                        }
