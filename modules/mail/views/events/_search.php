 ...
 * @var $model        app\models\search\MailerEventsTasksSearch
...
<div class="mailer-messages-search-form">
    <div class="row">
        <div class="col-md-12">
            <?php $form = ActiveForm::begin(['action' => ['messages'], 'method' => 'get', 'enableClientValidation' => false]); ?>
                                    ...
                                    'inputTemplate' =>
                                        '<div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                <a href="javascript:void(0);" id="mailerFrom_clear" class="btn btn-default date-clear" title="'.Yii::t('app', 'Clear date').'">
                                ...
                                echo $form->field($model, 'date_to', [
                                    'inputTemplate' =>
                                        '<div class="input-group">
                                            {input}
                                            <div class="input-group-btn">
                                                <a href="javascript:void(0);" id="mailerTo_clear" class="btn btn-default date-clear" title="'.Yii::t('app', 'Clear date').'">
                                                    <i class="fa fa-times"></i>
                                                </a>
                                            </div>
                                        </div>'
                    ...
                    <div class="row">
                        <div class="col-md-2 pull-right" style="margin-bottom: 10px">
                            <div class="pull-right">
                                ...
                                <?= Html::a(Yii::t('app', 'Reset'), yii\helpers\Url::to(['messages']), ['class' => 'btn btn-default']) ?>
                            </div>
                        </div>
                    </div>
                </div>
