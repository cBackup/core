    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <i class="fa fa-list"></i><h3 class="box-title box-title-align"><?= Yii::t('log', 'System logs') ?></h3>
                <div class="pull-right">
                    <?= Html::a('<i class="fa fa-search"></i> ' . Yii::t('app', 'Search'), 'javascript:;', ['class' => 'btn btn-sm bg-light-black search-button']) ?>
                </div>
            </div>
            <div class="box-body no-padding">
                <div class="system-log-search" style="display: none;">
                    <?php
                ...
                <?php Pjax::begin(['id' => 'system-log-pjax']); ?>
                    <?php
                    ...
                    echo GridView::widget([
                            ...
                            'afterRow'     => function($model) { /** @var $model \app\models\LogSystem */
                            ...
                            'columns' => [
                                [
                                    ...
                                    'value'          => function($model) { /** @var $model \app\models\LogSystem */
                                ...
                                [
                                    ...
                                    'value'         => function($data) { /** @var $data \app\models\LogSystem */
