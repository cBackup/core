 ...
 * @var $model        app\models\search\LogMailerSearch
...
<div class="mailer-log-search-form">
    <div class="row">
        <div class="col-md-12">
            <?php $form = ActiveForm::begin(['action' => ['list'], 'method' => 'get', 'enableClientValidation' => false]); ?>
                <div class="search-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <?php
                                echo $form->field($model, 'event_task_id')->textInput([
                                    'class'       => 'form-control',
                                    'placeholder' => Yii::t('app', 'Enter task id')
                                ]);
                            ?>
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-2">
                            <div class="pull-right" style="padding-top: 30px">
                                ...
                                <?= Html::a(Yii::t('app', 'Reset'), yii\helpers\Url::to(['list']), ['class' => 'btn btn-default']) ?>
                            </div>
                        </div>
                    </div>
                </div>
